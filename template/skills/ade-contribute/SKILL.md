---
name: ade-contribute
description: 從工作目錄修改中央 ADE 知識庫並開 PR（ADE repo 只在本地時 push 分支交人 merge）——包含主動撰寫（新增或調整 spec、skill、process、服務描述檔）與被動回流（發現 .claude/ade/knowledge/ 內容過期或缺漏）。使用者說「改 ADE 的 spec／skill」「把這個記回知識庫」「更新 ADE」「回流」時使用。
---
